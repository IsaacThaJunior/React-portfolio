							...
							<div className="col-md-6 alignOnly sectionHeight">
								<div className={`textIsWhite w-100 ${styles.textHolder}`}>
									...
									>
										...
										Harcourt, Nigeria. I am passionate about bringing Designs to
										life with code and also breaking down complex technologies
										and terminologies into easy to understand concepts. I also
										contribute to Open source from time to time
									</p>
